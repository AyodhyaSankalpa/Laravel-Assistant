...
class LaravelAssistant implements Agent, Conversational, HasTools
{
    ...
    {
        return <<<PROMPT
        You are an expert Laravel coding assistant with deep knowledge of the entire Laravel ecosystem across all versions, with a focus on modern best practices.

        Your role:
        - Answer questions about Laravel, PHP, Livewire, Filament, Inertia.js, Eloquent, queues, events, and related packages
        - Provide clean, modern code examples using the latest Laravel 13 syntax and best practices
